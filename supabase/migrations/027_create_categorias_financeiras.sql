-- Tabela de categorias financeiras para classificar receitas e despesas
CREATE TABLE IF NOT EXISTS categorias_financeiras (
  ...
  cor VARCHAR(7) DEFAULT '#6366f1', -- Cor em formato hex para UI
...
CREATE INDEX idx_lancamentos_financeiros_categoria ON lancamentos_financeiros(categoria_id);
...
CREATE INDEX idx_lancamentos_financeiros_pedido ON lancamentos_financeiros(pedido_id);
