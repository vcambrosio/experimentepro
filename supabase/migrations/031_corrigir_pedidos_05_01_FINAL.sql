-- CORREÇÃO FINAL: Atualizar pedidos de 05/01/2026
-- Estratégia: Primeiro define todos como evento_cesta, depois atualiza apenas os que são claramente venda_loja

-- PASSO 1: Definir TODOS os pedidos do dia como evento_cesta
...
-- PASSO 2: Atualizar APENAS os que são claramente venda_loja
-- Critérios para venda_loja: NÃO tem setor_id E NÃO tem orcamento_id
UPDATE public.pedidos
